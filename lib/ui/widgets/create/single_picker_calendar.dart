...
class CalendarSinglePicker extends StatefulWidget {
  ...
  @override
  _CalendarSinglePickerState createState() => _CalendarSinglePickerState();
}

class _CalendarSinglePickerState extends State<CalendarSinglePicker> {
        ...
        if (this.widget.dayBuilder != null) {
          ...
          dayWidgets.add(
            CalendarTile(
              ...
              hasSelection: day == _selectedDate,
            ),
          );
        }
      },
